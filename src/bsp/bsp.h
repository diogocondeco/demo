...
#define BSP_LONG_PUSH_TIMEOUT_MS (1000) /**< The time to hold for a long push (in milliseconds). */
//#define BSP_LONG_PUSH_STOP_TIMEOUT_MS (5000) /**< The time to hold for a long push (in milliseconds). */
#define BSP_LONG_PUSH_DFU_TIMEOUT_MS (7000) /**< The time to hold for a long push (in milliseconds). */
