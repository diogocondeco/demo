...
#define SPI_MASTER					SPI_MASTER_1
#define SPI_MASTER_CONFIG_FREQ		SPI_FREQUENCY_FREQUENCY_M8
#define SPI_MASTER_CONFIG_ORDER		SPI_CONFIG_ORDER_MsbFirst
#endif
...
#define TWI1_CONFIG_SCL TWI_CLK
#define TWI1_CONFIG_SDA TWI_SDA
